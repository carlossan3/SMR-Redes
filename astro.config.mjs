...
const unidadesExpandidas = {
  '01-fundamentos-estructura-representacion': [
    {
      slug: '01-fundamentos-estructura-representacion/01-que-es-una-red-local',
      label: '1 · ¿Qué es una red local?',
    },
    {
      slug: '01-fundamentos-estructura-representacion/02-componentes-basicos-de-una-red',
      label: '2 · Componentes básicos de una red',
    },
    {
      slug: '01-fundamentos-estructura-representacion/03-tipos-de-red-y-alcance',
      label: '3 · Tipos de red y alcance',
    },
    {
      slug: '01-fundamentos-estructura-representacion/04-otras-formas-de-clasificar-una-red',
      label: '4 · Otras formas de clasificar una red',
    },
    {
      slug: '01-fundamentos-estructura-representacion/05-cliente-servidor-y-p2p',
      label: '5 · Cliente-servidor y P2P',
    },
    {
      slug: '01-fundamentos-estructura-representacion/06-topologia-fisica-y-logica',
      label: '6 · Topología física y lógica',
    },
    {
      slug: '01-fundamentos-estructura-representacion/07-estrella-bus-y-anillo',
      label: '7 · Estrella, bus y anillo',
    },
    {
      slug: '01-fundamentos-estructura-representacion/08-arbol-malla-e-hibridas',
      label: '8 · Árbol, malla e híbridas',
    },
    {
      slug: '01-fundamentos-estructura-representacion/09-dispositivos-finales-e-intermedios',
      label: '9 · Dispositivos finales e intermedios',
    },
    {
      slug: '01-fundamentos-estructura-representacion/10-switch-router-y-punto-de-acceso',
      label: '10 · Switch, router y punto de acceso',
    },
    {
      slug: '01-fundamentos-estructura-representacion/11-medios-de-transmision',
      label: '11 · Medios de transmisión: primera aproximación',
    },
    {
      slug: '01-fundamentos-estructura-representacion/12-introduccion-packet-tracer',
      label: '12 · Introducción práctica a Cisco Packet Tracer',
    },
    {
      slug: '01-fundamentos-estructura-representacion/13-comunicacion-y-protocolos',
      label: '13 · Comunicación y protocolos',
    },
    {
      slug: '01-fundamentos-estructura-representacion/14-modelos-osi-y-tcp-ip',
      label: '14 · Modelos OSI y TCP/IP',
    },
    {
      slug: '01-fundamentos-estructura-representacion/15-mac-ip-nombre-e-interfaz',
      label: '15 · MAC, IP, nombre e interfaz',
    },
    {
      slug: '01-fundamentos-estructura-representacion/16-mapas-y-representacion-de-una-lan',
      label: '16 · Mapas y representación de una LAN',
    },
    {
      slug: '01-fundamentos-estructura-representacion/17-caso-integrador',
